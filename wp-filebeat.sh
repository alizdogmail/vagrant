...
mysql -e "CREATE USER 'wpuser'@'localhost' IDENTIFIED BY 'Contrasena';"
mysql -e "GRANT ALL PRIVILEGES ON wordpress.* TO 'wpuser'@'localhost';"
mysql -e "FLUSH PRIVILEGES;"

mysql <<EOF
ALTER USER 'root'@'localhost' IDENTIFIED BY 'Contrasena';
...
sed -i 's/password_here/\contrasena/g' /var/www/html/wordpress/wp-config.php
